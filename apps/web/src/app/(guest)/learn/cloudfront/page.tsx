    ...
    <div className="py-12">
      <div className="space-y-8">
        ...
        <div className="flex flex-col items-end gap-2">
          <AwsQuickLink href="https://docs.aws.amazon.com/ko_kr/AmazonCloudFront/latest/DeveloperGuide/Introduction.html" />
            ...
            <div className="space-y-12">
              <div>
                ...
                <p className="leading-relaxed text-gray-700 dark:text-gray-300">
                  ...
                  콘텐츠를 빠르게 전송하는 CDN 서비스입니다. 사용자와 가장
                  가까운 엣지 로케이션에서 콘텐츠를 제공하여 지연 시간을
                  최소화하고 전송 속도를 향상시킵니다.
                </p>
              </div>
              <div>
                ...
                <ul className="space-y-3 leading-relaxed text-gray-700 dark:text-gray-300">
                  <li>
                    ...
                    CloudFront가 콘텐츠를 제공하기 위해 사용하는 구성
                    단위입니다. 웹 배포와 RTMP 배포 두 가지 유형이 있습니다.
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="list-inside list-disc space-y-2 leading-relaxed text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    <strong>SSL/TLS 지원:</strong> HTTPS를 통한 안전한 콘텐츠
                    전송
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className="mt-2 leading-relaxed text-gray-700 dark:text-gray-300">
                  사용 사례: A/B 테스팅, 사용자 인증, 이미지 리사이징, SEO
                  최적화 등
                </p>
              </div>
