    ...
    <div className="py-12">
      <div className="space-y-8">
        ...
        <div className="flex flex-col items-end gap-2">
          <AwsQuickLink href="https://docs.aws.amazon.com/ko_kr/AmazonS3/latest/userguide/Welcome.html" />
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <ul className="space-y-3 leading-relaxed text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    <strong className="text-foreground">키(Key):</strong> 버킷
                    내 객체의 고유 식별자입니다. 버킷, 키, 버전 ID의 조합으로 각
                    객체를 고유하게 식별합니다.
                  </li>
                  <li>
                    <strong className="text-foreground">리전(Region):</strong>{' '}
                    버킷이 저장되는 지리적 AWS 리전입니다. 지연 시간 최소화,
                    비용 절감, 규제 요구 사항 충족을 위해 선택합니다.
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p className="mb-3 leading-relaxed text-gray-700 dark:text-gray-300">
                  S3는 다양한 사용 사례에 맞는 여러 스토리지 클래스를
                  제공합니다:
                </p>
                <ul className="space-y-2 leading-relaxed text-gray-700 dark:text-gray-300">
                  <li>
                    <strong className="text-foreground">S3 Standard:</strong>{' '}
                    자주 액세스하는 데이터를 위한 기본 스토리지 클래스
                  </li>
                  <li>
